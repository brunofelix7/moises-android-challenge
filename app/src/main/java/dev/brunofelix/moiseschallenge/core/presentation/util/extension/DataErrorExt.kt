package dev.brunofelix.moiseschallenge.core.presentation.util.extension

import dev.brunofelix.moiseschallenge.R
import dev.brunofelix.moiseschallenge.core.domain.util.exception.LocalException
...
fun LocalException.toUiText(): UiText {
    return when (this) {
        ...
        is LocalException.PermissionDenied -> UiText.StringResource(R.string.error_local_database)
        is LocalException.DiskFull -> UiText.StringResource(R.string.error_local_database)
